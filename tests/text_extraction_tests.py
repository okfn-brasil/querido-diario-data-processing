...
from data_extraction import get_text_from_file, TextExtractorWrapper
...
class TextExtractorWrapperTest(TestCase):

    def setUp(self):
        self.url = "http://localhost:9998"
        self.extractor = TextExtractorWrapper(self.url)
